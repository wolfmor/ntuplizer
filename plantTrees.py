...
for f in options.inputFiles:
    ...
    for ievent, event in enumerate(events):
        ...
        electrons = [e for e in electrons
                     if passesEleID(e, pv_pos, wp='veto')
                     and e.pt() > 10
                     and abs(e.eta()) < 2.5]
        ...
        for it, t in enumerate(tauswithdiscriminators):
            ...
            if (not t[0].leadPFChargedHadrCand() is None) and t[0].leadPFChargedHadrCand().trackRef().isNonnull():
