...
#cmsRun construct_secondary_vertices_cfg.py inputFiles="file:///pnfs/desy.de/cms/tier2/store/user/sbein/CommonSamples/RadiativeMu_2016Fast/v4/step3_higgsino_RunIISpring21UL16FS_susyall_mChipm115GeV_dm0p768GeV_Chi20ctau5MM_part11of25.root"  maxEvents=-1 crab=False outputFile="test_ss_Chipm115GeV_dm0p7GeV_Chi20ctau5MM_part11of25.root"
...
process.SecondaryVerticesFromLooseTracks = process.generalV0Candidates.clone(      
	...
	sameSign = cms.bool(options.sameSign),	
