...
datasets = [
			...
			,'/WJetsToLNu_HT-2500ToInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16RECOAPV-106X_mcRun2_asymptotic_preVFP_v8_ext1-v1/AODSIM' ## To Do submit
...
def submitToCrab():
	...
	for ijob, dataset in enumerate(datasets):
		...
		f.write("config.Data.outLFNDirBase = \"/store/user/altews/NTuples/NTuplesVXXX/16UL_preAPV/\"\n")
		if limitNJobs:
			f.write("NJOBS = 1 \n")
